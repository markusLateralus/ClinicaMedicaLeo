...
<html lang="es">
<head>
    <title>Notificaciones Paciente</title>
...
<div class="mensajes-container">
    ...
    <ul>
        <% for (int i = 0; i < notificaciones.size(); i++) { %>
            <li>
                <%= notificaciones.get(i).getMensaje() %>
                <a href="NotificacionServlet?action=eliminar&id=<%=notificaciones.get(i).getId() %>&idPaciente=<%=paciente.getId()%>" class="eliminar-notificacion">Eliminar</a>
