...
<title>Insertar paciente</title>
  <link rel="stylesheet" href="./css/InsertarPacienteA.css"> <!-- Enlace al archivo CSS -->
</head>
<%
...
<br><br>
 ...
 <h2>Desde aquí puedes dar de alta un paciente nuevo</h2>
   <main>
<form id="formularioInsertarPaciente" action="AdministradorServlet" method="post">
   <fieldset>
                <legend>DATOS DEL PACIENTE</legend>
            <div class="form-group">
        <input type="hidden" name="action" value="crearPacienteA">
            </div>
              <div class="form-group">
  ...
  <div class="form-group">
        ...
        <input type="text" id="apellido1" name="apellido1"  minlength="4" maxlength="20"  placeholder="mi userName"  pattern="^(?=.*[aeiouáéíóúàèìòùäëïöü]).{2,10}$" 
  ...
  <div class="form-group">
        <input type="submit" id="enviar" value="dar alta paciente">
        </div>
                <div class="form-group">
  ...
  <script src="./js/ValidacionFormularioInsertarPacienteA.js"></script>
